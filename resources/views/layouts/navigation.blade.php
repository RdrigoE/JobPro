<nav x-data="{ open: false }" class="bg-gray-900  border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-around h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        <img src="Logo.png" class="h-14 mr-3" alt="JobPro Logo" />
                    </a>
                </div>
                ...
                <div class="hidden text-white space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('saved-jobs.index')" :active="request()->routeIs('saved-jobs.index')">
                        {{ __('Saved Jobs') }}
                    </x-nav-link>
                </div>
                <div class="hidden text-white space-x-8 sm:-my-px sm:ml-10 sm:flex">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('saved-jobs.index')" :active="request()->routeIs('saved-jobs.index')">
                    {{ __('Saved Jobs') }}
                </x-responsive-nav-link>
            </div>
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('my-jobs')" :active="request()->routeIs('my-jobs')">
                    {{ __('My Jobs') }}
                </x-responsive-nav-link>
            </div>
